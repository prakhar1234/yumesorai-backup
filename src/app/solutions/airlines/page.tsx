...
const data = industryData.airlines;
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: data.seo.description,
    url: `${siteUrl}/solutions/airlines`,
    type: "website",
    images: [
      {
        url: "/og-airlines.png",
        width: 1200,
        height: 630,
        alt: "Yumesorai Airline Legacy Modernization",
      },
    ],
  },
  twitter: {
  ...
  alternates: {
    canonical: `${siteUrl}/solutions/airlines`,
  },
};

function AirlinesFAQSchema() {
  const schema = {
...
function AirlinesServiceSchema() {
  const schema = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Airline Legacy System Modernization",
    provider: {
      "@type": "Organization",
      name: "Yumesorai",
      url: siteUrl,
    ...
    audience: {
      "@type": "Audience",
      audienceType: "Airline CIOs and CTOs",
    },
  };
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-base text-indigo-950/60">
              Common questions from airline technology leaders evaluating legacy
              modernization.
            </p>
          </div>
